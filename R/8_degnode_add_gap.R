...
cycle_edge_flux_list_in_main <- function(output_path, res_path, package_path, input_tumor_name, prm_1, prm_2, prm_3, prm_4) {
  ...
  ##
  cycle_edge_flux_list_in = get_cycle_edge_flux_list(cycle_edgesucs_expression_in, tumors_array, stat_all, DEG_selected, gene_missing_list, prm_1, prm_2, prm_3, prm_4)
...
cycle_edge_flux_list_out_main <- function(output_path, res_path, package_path, input_tumor_name, prm_1, prm_2, prm_3, prm_4) {
  ...
  ##
  cycle_edge_flux_list_out = get_cycle_edge_flux_list(cycle_edgesucs_expression_out, tumors_array, stat_all, DEG_selected, gene_missing_list, prm_1, prm_2, prm_3, prm_4)
...
# prm_3=1
# prm_4=1
# cycle_edge_flux_list_inout_main(output_path, res_path, package_path, input_tumor_name, prm_1, prm_2, prm_3, prm_4)
