...
subnet_edge_flux_list_main <- function(output_path, res_path, package_path, input_tumor_name, prm_1, prm_2, prm_3, prm_4) {
  #init
  ...
  ##
  subnet_edge_flux_list = get_cycle_edge_flux_list(subnet_edge_expression, tumors_array, stat_all, DEG_selected, gene_missing_list, prm_1, prm_2, prm_3, prm_4)
...
# prm_3=1
# prm_4=1
# subnet_edge_flux_list_main(output_path, res_path, package_path, input_tumor_name, prm_1, prm_2, prm_3, prm_4)
