...
get_tumor_gap_foldchangesign<-function(gene_foldchange_list, tumor_name, subnet_edge_expression, gene_missing_list, is_filter)
{
...
####################################################################################
## main function
get_cycle_edge_flux_list <- function(subnet_edge_expression, tumors_array, gene_foldchange_list, gene_meanval_list, gene_missing_list, to_find_correct_symbol_v1_1, par1, par2, par3, par4) {
  #tumor_cyc_gap_foldchangsign = get_tumor_cyc_gap_foldchangsign(subnet_edge_expression)
  ...
  for (i in 1:length(tumors_array)) {
    #保存到tumor字典
    gap_updown = get_tumor_gap_foldchangesign(gene_foldchange_list, tumors_array[i], subnet_edge_expression, gene_missing_list, FALSE)
...
subnet_edge_flux_list_main <- function(output_path, res_path, package_path, input_tumor_name, par1=1, par2=10, par3=-2, par4=1.71) {
  #init
  ...
  ##
  subnet_edge_flux_list = get_cycle_edge_flux_list(subnet_edge_expression, tumors_array, gene_foldchange_list, gene_meanval_list, gene_missing_list, to_find_correct_symbol_v1_1, par1, par2, par3, par4)
  ...
  #save(subnet_edge_flux_list, file="E:/scFEA_universal/my_R/aimA/rdata_cycle_detect/3_flux_subnet/result_final/subnet_edge_flux_list.RData")
