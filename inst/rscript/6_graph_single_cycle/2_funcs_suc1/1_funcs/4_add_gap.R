...
cycle_edge_flux_list_inout_main <- function(output_path, res_path, package_path, input_tumor_name) {
  #init
  ...
  ##
  cycle_edge_flux_list_in = get_cycle_edge_flux_list(cycle_edgesucs_expression_in, tumors_array, stat_all, DEG_selected, gene_missing_list)
  cycle_edge_flux_list_out = get_cycle_edge_flux_list(cycle_edgesucs_expression_out, tumors_array, stat_all, DEG_selected, gene_missing_list)
