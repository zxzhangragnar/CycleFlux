...
cycle_successors_expression_main <- function(output_path, res_path, package_path, input_tumor_name, par1=1, par2=10, par3=-2, par4=1.71) {
  ...
  ##
  cycle_edge_flux_list_2_1 = get_cycle_edge_flux_list(cycle_successors_2_expression_1, tumors_array, gene_foldchange_list, gene_meanval_list, gene_missing_list, to_find_correct_symbol_v1_1, par1, par2, par3, par4)
  cycle_edge_flux_list_2_2 = get_cycle_edge_flux_list(cycle_successors_2_expression_2, tumors_array, gene_foldchange_list, gene_meanval_list, gene_missing_list, to_find_correct_symbol_v1_1, par1, par2, par3, par4)
  cycle_edge_flux_list_3_1 = get_cycle_edge_flux_list(cycle_successors_3_expression_1, tumors_array, gene_foldchange_list, gene_meanval_list, gene_missing_list, to_find_correct_symbol_v1_1, par1, par2, par3, par4)
  cycle_edge_flux_list_3_2 = get_cycle_edge_flux_list(cycle_successors_3_expression_2, tumors_array, gene_foldchange_list, gene_meanval_list, gene_missing_list, to_find_correct_symbol_v1_1, par1, par2, par3, par4)
  ...
  # save(cycle_edge_flux_list_2_1, file="E:/scFEA_universal/my_R/aimA/rdata_cycle_detect/6_graph_single_cycle/2_funcs_suc2/cyc_successors_data/cycle_edge_flux_list_2_1.RData")
  # save(cycle_edge_flux_list_2_2, file="E:/scFEA_universal/my_R/aimA/rdata_cycle_detect/6_graph_single_cycle/2_funcs_suc2/cyc_successors_data/cycle_edge_flux_list_2_2.RData")
  # save(cycle_edge_flux_list_3_1, file="E:/scFEA_universal/my_R/aimA/rdata_cycle_detect/6_graph_single_cycle/2_funcs_suc2/cyc_successors_data/cycle_edge_flux_list_3_1.RData")
  # save(cycle_edge_flux_list_3_2, file="E:/scFEA_universal/my_R/aimA/rdata_cycle_detect/6_graph_single_cycle/2_funcs_suc2/cyc_successors_data/cycle_edge_flux_list_3_2.RData")
