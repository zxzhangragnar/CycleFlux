...
cycle_successors_expression_main <- function(output_path, res_path, package_path, input_tumor_name, prm_1, prm_2, prm_3, prm_4) {
  #init
  ...
  ##
  cycle_edge_flux_list_2_1 = get_cycle_edge_flux_list(cycle_successors_2_expression_1, tumors_array, stat_all, DEG_selected, gene_missing_list, prm_1, prm_2, prm_3, prm_4)
  cycle_edge_flux_list_2_2 = get_cycle_edge_flux_list(cycle_successors_2_expression_2, tumors_array, stat_all, DEG_selected, gene_missing_list, prm_1, prm_2, prm_3, prm_4)
  cycle_edge_flux_list_3_1 = get_cycle_edge_flux_list(cycle_successors_3_expression_1, tumors_array, stat_all, DEG_selected, gene_missing_list, prm_1, prm_2, prm_3, prm_4)
  cycle_edge_flux_list_3_2 = get_cycle_edge_flux_list(cycle_successors_3_expression_2, tumors_array, stat_all, DEG_selected, gene_missing_list, prm_1, prm_2, prm_3, prm_4)
