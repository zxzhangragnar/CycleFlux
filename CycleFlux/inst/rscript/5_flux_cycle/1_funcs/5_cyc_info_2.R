...
######################################################################################################
# tumor_cyc_enzyme_count_type 给 tumor_cyc_updownsign 增加4列
# 第一列:count
# 第二列:count_N
# 第三列:FC
# 第四列:count_FC
...
cyc_info_2_main <- function(res_path, input_tumor_name) {
  ...
  load(file.path(res_path, "5_flux_cycle/result_enzyme/tumor_cyc_enzyme_count_type.RData"))
  load(file.path(res_path, "5_flux_cycle/result_enzyme/tumor_normal_gene_count.RData"))
  load(file.path(res_path, "5_flux_cycle/result_enzyme/tumor_cyc_updownsign.RData"))
